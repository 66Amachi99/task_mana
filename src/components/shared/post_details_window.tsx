                ...
                <div className="lg:w-3/5 flex flex-col">
                  ...
                  <div className="space-y-3 max-h-[40vh] md:max-h-none overflow-y-auto pr-1">
                    {tasks.length > 0 ? (
                          ...
                          >
                            <div className="flex flex-col sm:flex-row sm:items-start gap-2 mb-2">
                              <div className="sm:w-1/4">
                                <h4 className="font-medium text-gray-800 text-xs md:text-sm flex items-center gap-1">
                                  {task.label}
                              ...
                              <div className="sm:w-3/4">
                                {userCanEdit ? (
                                  ...
                                  <div className="w-full px-2 py-1.5 bg-gray-100 border border-gray-200 rounded-md text-xs text-gray-500 truncate">
                                    {task.link || 'Нет доступа'}
                                  </div>
                                )}
                              </div>
                            </div>
                            ...
                            <div className="mt-2 pt-2 border-t">
                              {hasLink ? (
                                ...
                                <p className="text-xs text-gray-500">Задача не выполнена</p>
                              )}
                            </div>
                          </div>
                        );
                      ...
                      <p className="text-center py-4 text-gray-500 text-sm">Нет задач</p>
                    )}
                  </div>
                </div>
              </div>
              ...
              <div className="mt-4 pt-3 border-t flex justify-between items-center">
                {canEditPost && (
                  <button
                    ...
                    className="px-3 py-1.5 bg-gray-200 text-gray-800 rounded-md hover:bg-gray-300 text-xs font-medium flex items-center gap-1"
                  >
                ...
                <button
                  onClick={handleSave}
                  disabled={isSaving}
                  className={`px-3 py-1.5 text-white rounded-md text-xs font-medium flex items-center gap-1 ${
